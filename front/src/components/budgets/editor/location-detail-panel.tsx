...
import { SectionSceneCard } from "./section-scene-card";
      ...
      <div className="p-4 md:p-6 space-y-6">
        ...
        <div className="space-y-6">
          ...
          {sections.map((section, secIdx) => {
            const locNum = locationIndex >= 0 ? `${sectionNumber}.${locationIndex + 1}` : "";
            const secNumber = locNum ? `${locNum}.${secIdx + 1}` : "";
            return (
              <SectionSceneCard
                key={section.id}
                section={section}
