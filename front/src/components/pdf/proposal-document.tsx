...
export const ProposalDocument = ({
    ...
    const renderPdfSegment = (seg: PdfSegment, i: number): React.ReactNode => {
        ...
        const innerCommon = {
            ...
            innerHeaderText,
            innerFooterText,
            showInnerHeaderBand: headerFooterProps.inner_show_header_band === true,
            showInnerFooterBand: headerFooterProps.inner_show_footer_band === true,
